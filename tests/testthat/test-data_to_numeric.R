...
test_that("convert character to numeric Date", {
  ...
  expect_warning(expect_identical(to_numeric(as.POSIXct("2022-01-01")), 1640991600))
  expect_warning(expect_identical(to_numeric(as.POSIXlt("2022-01-01")), 1640991600))
})
