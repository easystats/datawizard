test_that("skewness", {
  ...
  expect_equal(skewness(iris$Sepal.Length, iterations = 100)[[1]], 0.314911, tolerance = 1e-3)
...
test_that("kurtosis", {
  ...
  expect_equal(kurtosis(iris$Sepal.Length, iterations = 100)[[1]], -0.552064, tolerance = 1e-3)
