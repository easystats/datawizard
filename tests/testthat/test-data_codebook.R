...
test_that("data_codebook iris", {
  ...
  expect_equal(
    ...
    c(
      ...
      "---+--------------+-------------+----------+------------+-----------",
      "1  | Sepal.Length | numeric     | 0 (0.0%) | [4.3, 7.9] | 150 (100%)",
      "---+--------------+-------------+----------+------------+-----------",
      "2  | Sepal.Width  | numeric     | 0 (0.0%) |   [2, 4.4] | 150 (100%)",
      "---+--------------+-------------+----------+------------+-----------",
      "3  | Petal.Length | numeric     | 0 (0.0%) |   [1, 6.9] | 150 (100%)",
      "---+--------------+-------------+----------+------------+-----------",
      "4  | Petal.Width  | numeric     | 0 (0.0%) | [0.1, 2.5] | 150 (100%)",
      "---+--------------+-------------+----------+------------+-----------",
...
test_that("data_codebook efc", {
  ...
  expect_equal(
    ...
    c(
      ...
      "---+----------+------------------------------------------+-------------+------------+----------+---------------------------------+-----------",
      "1  | c12hour  | average number of hours of care per week | numeric     |   2 (2.0%) | [5, 168] |                                 |  98 (100%)", 
      "---+----------+------------------------------------------+-------------+------------+----------+---------------------------------+-----------",
      "2  | e16sex   | elder's gender                           | numeric     |   0 (0.0%) |        1 | male                            |   46 (46%)",
      "   |          |                                          |             |            |        2 | female                          |   54 (54%)", 
      "---+----------+------------------------------------------+-------------+------------+----------+---------------------------------+-----------",
      ...
      "---+----------+------------------------------------------+-------------+------------+----------+---------------------------------+-----------",
      "5  | neg_c_7  | Negative impact with 7 items             | numeric     |   3 (3.0%) |  [7, 28] |                                 |  97 (100%)", 
      "---------------------------------------------------------------------------------------------------------------------------------------------"
    )
  )
})
...
test_that("data_codebook efc, variable_label_width", {
  ...
  expect_equal(
    ...
    c(
      ...
      "ID | Name     | Label                        | Type        |   Missings |   Values | Value Labels                    |      N (%)",
      "---+----------+------------------------------+-------------+------------+----------+---------------------------------+-----------",
      "1  | c12hour  | average number of hours of   | numeric     |   2 (2.0%) | [5, 168] |                                 |  98 (100%)",
      "   |          | care per week                |             |            |          |                                 |           ",
      "---+----------+------------------------------+-------------+------------+----------+---------------------------------+-----------",
      "2  | e16sex   | elder's gender               | numeric     |   0 (0.0%) |        1 | male                            |   46 (46%)",
      "   |          |                              |             |            |        2 | female                          |   54 (54%)",
