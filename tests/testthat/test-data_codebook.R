...
test_that("data_codebook efc", {
  ...
  expect_equal(
    ...
    c(
      ...
      "ID |     Name |  missings |                                    Label |   Values |                    Value Labels |  N",
      "---+----------+-----------+------------------------------------------+----------+---------------------------------+---",
      "1  |  c12hour |  2 (0.0%) | average number of hours of care per week | [5, 168] |                                 | 98",
      "---+----------+-----------+------------------------------------------+----------+---------------------------------+---",
      "2  |   e16sex |  0 (0.0%) |                           elder's gender |        1 |                            male | 46",
      "   |          |           |                                          |        2 |                          female | 54",
      "---+----------+-----------+------------------------------------------+----------+---------------------------------+---",
      "3  |   e42dep |  3 (0.0%) |                       elder's dependency |        1 |                     independent |  2",
      "   |          |           |                                          |        2 |              slightly dependent |  4",
      "   |          |           |                                          |        3 |            moderately dependent | 28",
      "   |          |           |                                          |        4 |              severely dependent | 63",
      "---+----------+-----------+------------------------------------------+----------+---------------------------------+---",
      "4  | c172code | 10 (0.1%) |               carer's level of education |        1 |          low level of education |  8",
      "   |          |           |                                          |        2 | intermediate level of education | 66",
      "   |          |           |                                          |        3 |         high level of education | 16",
      "---+----------+-----------+------------------------------------------+----------+---------------------------------+---",
      "5  |  neg_c_7 |  3 (0.0%) |             Negative impact with 7 items |  [7, 28] |                                 | 97",
      "----------------------------------------------------------------------------------------------------------------------"
    )
  )
})
...
test_that("data_codebook efc, label_width", {
  ...
  expect_equal(
    ...
    c(
      ...
      "ID |     Name |  missings |                        Label |   Values |                    Value Labels |  N",
      "---+----------+-----------+------------------------------+----------+---------------------------------+---",
      "1  |  c12hour |  2 (0.0%) |   average number of hours of | [5, 168] |                                 | 98",
      "   |          |           |                care per week |          |                                 |   ",
      "---+----------+-----------+------------------------------+----------+---------------------------------+---",
      "2  |   e16sex |  0 (0.0%) |               elder's gender |        1 |                            male | 46",
      "   |          |           |                              |        2 |                          female | 54",
