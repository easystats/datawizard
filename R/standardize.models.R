...
.standardize_models <- function(x,
  ...
  data <- insight::get_data(x, source = "mf")
...
standardize.mediate <- function(x,
  ...
  y <- x$model.y
  m <- x$model.m
  y_data <- insight::get_data(y, source = "mf")
  m_data <- insight::get_data(m, source = "mf")
  ...
  y_data_std <- insight::get_data(y_std, source = "mf")
  m_data_std <- insight::get_data(m_std, source = "mf")
