---
title: "A quick summary of selecting syntax in `{datawizard}`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{A quick summary of selecting syntax in `{datawizard}`}
...
*provided it returns `TRUE` or `FALSE`* when applied to a column.
...
if we wanted to, we can use both `select` and `exclude` arguments at the same 
time.
